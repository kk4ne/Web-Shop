...
namespace testASP.REACTproject.Controllers
{
    public class OrderItemsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Products, "Id", "Characteristic");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,OrderId,ProductId")] OrderItem orderItem)
        {
            ...
            ViewData["OrderId"] = new SelectList(_context.Orders, "Id", "Address", orderItem.OrderId);
            ViewData["ProductId"] = new SelectList(_context.Products, "Id", "Characteristic", orderItem.ProductId);
            return View(orderItem);
        }
